...
2. verifier les labels config (`fusion_test_01` / `fusion_primary_01`);
3. lancer `tools/deploy_post_main_dual_target.ps1 -TestComputer fusion_test_01 -PrimaryComputer fusion_primary_01`;
